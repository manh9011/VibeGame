...
/**
 * Generates level backgrounds based on level type and distance.
 */
export class BackgroundGenerator {
    /** Width of the background to generate (in tiles). */
    Width: number;
    /** Height of the background to generate (in tiles). */
    Height: number;
    /** Whether this is a distant (parallax) background. */
    Distant: boolean;
    /** The type of level being generated (e.g., Overground). */
    Type: number;
     ...
     * @param distant Whether this is a distant background.
     * @param type The type of level (Overground, Underground, etc).
     */
    ...
    /**
     * Creates the background level data.
     */
    CreateLevel(): Level {
    ...
    /**
     * Generates an overground-themed background.
    ...
    /**
     * Generates an underground-themed background.
     * @param level The level object to populate.
     */
    ...
    /**
     * Generates a castle-themed background.
     * @param level The level object to populate.
     */
