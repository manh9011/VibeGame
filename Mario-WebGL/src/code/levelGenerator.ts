import { Level, LevelType, Odds } from './level';
...
export class LevelGenerator {
    /** Width of the level to generate. */
    Width: number;
    /** Height of the level to generate. */
    Height: number;
    /** Odds table for feature generation. */
    Odds: number[];
    /** Total weight of odds. */
    TotalOdds: number;
    /** Difficulty level (effects enemy spawn rate and types). */
    Difficulty: number;
    /** Level type (Overground, Underground, Castle). */
    Type: number;
    ...
    /**
     * Creates a new level with the specified type and difficulty.
     */
    CreateLevel(type: number, difficulty: number): Level {
        var i = 0, length = 0, floor = 0, x = 0, y = 0, ceiling = 0, run = 0, level: Level;
    ...
    /**
     * Builds a zone within the level using random features.
     */
    ...
    /**
     * Builds a specific jump feature.
     */
    ...
    /**
     * Builds a straight hill feature.
     */
    BuildHillStraight(level: Level, xo: number, maxLength: number): number {
        var length = ((Math.random() * 10) | 0) + 10, floor = this.Height - 1 - (Math.random() * 4) | 0,
            x = 0, y = 0, h = floor, keepGoing = true, l = 0, xxo = 0, occupied: boolean[] = [], xx = 0, yy = 0;
    ...
    /**
     * Adds a line of enemies to the level.
     */
    ...
    /**
     * Decorates the level with scenery and enemies.
     */
    ...
    /**
     * Post-processing to fix wall connections.
     */
    FixWalls(level: Level): void {
        var blockMap: boolean[][] = [], x = 0, y = 0, xx = 0, yy = 0, blocks = 0;
    ...
    /**
     * Converts boolean block map to actual tiles.
     */
    Blockify(level: Level, blocks: boolean[][], width: number, height: number): void {
        var to = 0, b: boolean[][] = [], x = 0, y = 0, xx = 0, yy = 0, i = 0, _xx = 0, _yy = 0;
